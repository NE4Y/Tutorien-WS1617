...
#reader(lib "DMdA-vanilla-reader.ss" "deinprogramm")((modname live_coding_13_12_2016) (read-case-sensitive #f) (teachpacks ((lib "image2.ss" "teachpack" "deinprogramm"))) (deinprogramm-settings #(#f write repeating-decimal #f #t none explicit #f ((lib "image2.ss" "teachpack" "deinprogramm")))))
...
(check-error (get-nth-element 1 empty) "Dieses Element existiert nicht")
(check-error (get-nth-element 1 (list 3)) "Dieses Element existiert nicht")
(define get-nth-element
  (lambda (n ls)
    (cond
      ((empty? ls) (violation "Dieses Element existiert nicht"))
...
(check-expect (even-fib-sum 10) 10)
(define even-fib-sum
  (lambda (upperBound)
    (letrec
        ((worker
